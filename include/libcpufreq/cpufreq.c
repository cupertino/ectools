...
void
cpufreq_put_available_governors(struct cpufreq_available_governors *any)
{
...
void
cpufreq_put_available_frequencies(struct cpufreq_available_frequencies *any)
{
...
void
cpufreq_put_affected_cpus(struct cpufreq_affected_cpus *any)
{
...
void
cpufreq_put_related_cpus(struct cpufreq_affected_cpus *any)
{
