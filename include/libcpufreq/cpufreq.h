...
extern "C"
{
  ...
  extern int
  cpufreq_cpu_exists(unsigned int cpu);
  ...
  extern unsigned long
  cpufreq_get_freq_hardware(unsigned int cpu);
...
#define cpufreq_get(cpu) cpufreq_get_freq_kernel(cpu);
  ...
  extern int
  cpufreq_get_hardware_limits(unsigned int cpu, unsigned long *min,
      unsigned long *max);
  ...
  extern void
  cpufreq_put_policy(struct cpufreq_policy *policy);
  ...
  *
  ...
  extern void
  cpufreq_put_available_governors(struct cpufreq_available_governors *first);
  ...
  *
  ...
  extern struct cpufreq_affected_cpus *
  cpufreq_get_affected_cpus(unsigned
  int cpu);

  extern void
  cpufreq_put_affected_cpus(struct cpufreq_affected_cpus *first);
  ...
  extern struct cpufreq_affected_cpus *
  cpufreq_get_related_cpus(unsigned
  int cpu);

  extern void
  cpufreq_put_related_cpus(struct cpufreq_affected_cpus *first);
  ...
  extern struct cpufreq_stats *
  cpufreq_get_stats(unsigned int cpu, unsigned long long *total_time);

  extern void
  cpufreq_put_stats(struct cpufreq_stats *stats);
  ...
  extern int
  cpufreq_set_policy(unsigned int cpu, struct cpufreq_policy *policy);
  ...
  extern int
  cpufreq_modify_policy_min(unsigned int cpu, unsigned long min_freq);
  extern int
  cpufreq_modify_policy_max(unsigned int cpu, unsigned long max_freq);
  extern int
  cpufreq_modify_policy_governor(unsigned int cpu, char *governor);
  ...
  extern int
  cpufreq_set_frequency(unsigned int cpu, unsigned long target_frequency);
