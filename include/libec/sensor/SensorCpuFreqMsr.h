...
#ifndef LIBEC_SENSORCPUFREQMSR_H__
#define LIBEC_SENSORCPUFREQMSR_H__
...
{
  /// Need to be root
  class CpuFreqMsr : public Sensor
  {
  ...
  public:
    ...
    /// Constructor
    CpuFreqMsr(unsigned short cpuId = 0);
  ...
  protected:
    ...
    int
    mperf_get_count_freq(unsigned long long *count, unsigned int cpu);
    int
