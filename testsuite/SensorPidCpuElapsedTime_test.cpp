...
main()
{
  cea::CpuElapsedTime cet;
  pid_t pid;

  std::cout << "Testing class:        " << cet.ClassName << std::endl;
  pid = getpid();
  ...
  std::cout << "  Machine CPU time:   " << cet.getValue().U64 << std::endl;
  std::cout << "  Process Id:         " << pid << std::endl;
  std::cout << "  Process CPU time:   " << cet.getValuePid(pid).U64
      << std::endl;
  ...
  cea::SensorController::storeXML(cet, "/tmp/cputime.xml");
